...
def ResNet18(model_input, classes=10):
    ...
    conv3_3 = conv2d_bn(conv3_2, 128, (1, 1), strides=2, activation=None) # (56, 56, 64) -> (28, 28, 128)
    
    shortcut_2 = Add()([conv3_3, shortcut_1])
    ...
    conv4_3 = conv2d_bn(conv4_2, 256, (1, 1), strides=2, activation=None) # (28, 28, 128) -> (14, 14, 256)
    
    shortcut_3 = Add()([conv4_3, shortcut_2])
    ...
    conv5_3 = conv2d_bn(conv5_2, 512, (1, 1), strides=2, activation=None) # (14, 14, 256) -> (7, 7, 512)
    
    shortcut_4 = Add()([conv5_3, shortcut_3])
